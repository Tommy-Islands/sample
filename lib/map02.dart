...
class map02 extends StatelessWidget {
  const map02({Key? key});
...
class _mapState extends State<point> with AutomaticKeepAliveClientMixin {
  ...
  late String userId;
  final CollectionReference iconsCollection02 =
      FirebaseFirestore.instance.collection('icons02');
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: iconsCollection02.snapshots(),
          ...
          children: [
            GestureDetector(
              onTapDown: (tapDownDetails) {
                ...
                iconsCollection02.add(newIcon.toMap());
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (iconDataPoint.userId == getUserId()) {
                            ...
                            iconsCollection02.doc(doc.id).delete();
                          }
                        },
                        child: Icon(
                          Icons.cruelty_free,
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                onPressed: () {
                  // 'icons02' コレクションからすべてのアイコンを削除
                  iconsCollection02.get().then((snapshot) {
